...
const Fields = () => {
        ...
        return ( <
                >
                <
                div > {!dataConfirmed && < button class = "but"
                    onClick = {
                        () => setShowFieldOptions(true) } > Add Field < /button>} { showFieldOptions && renderFieldOptions() } {
                        fields.map(field => ( <
                    ...
                    /div> {
                        ...
                        /> <
                        button className = "but danger"
                        onClick = { handleReset } > Reset < /button> <
                            button className = "but custbut"
